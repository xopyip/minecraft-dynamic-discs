...
class VideoSoundInstance @JvmOverloads constructor(
    ...
    private val loc = Identifier(MOD_ID, videoId.toString())

    private val weighed = WeightedSoundSet(loc, null)
    private val sound =
        Sound(loc.toString(), volume, pitch, 1, Sound.RegistrationType.SOUND_EVENT, true, false, attenuationDistance)

    override fun getId() = loc;

    override fun getSoundSet(soundManager: SoundManager?) = weighed

    override fun getSound() = sound
    override fun getCategory(): SoundCategory = SoundCategory.RECORDS
